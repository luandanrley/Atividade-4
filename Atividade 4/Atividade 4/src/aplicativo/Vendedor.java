...
public class Vendedor extends Funcionario{
    ...
    public Vendedor(int idade, String nome, String cpf, String funcao, double salario, Gerente gerente, double totalVendas, double comissaoVendedor, double totalComissao) {
        super(idade, nome, cpf, funcao, salario);
